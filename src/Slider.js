...
const cards = [
  {
    ...
    bonus: [
      { name: "Siła: ", change: "+5"},
      { name: "Zwinność: ", change: ""},
      { name: "Wytrzymałość: ", change: "+10"},
      { name: "Żywotność: ", change: "+5"},
      { name: "Spostrzegawczość: ", change: ""},
      { name: "Inteligencja: ", change: ""},
      { name: "Szybkość: ", change: "-10"},
      { name: "Obrona: ", change: "+15"},
      { name: "Przyrost złota: ", change: "+50/h"},
      { name: "Przyrost drewna: ", change: ""},
      { name: "Przyrost materiału: ", change: ""},
    ],
  },
  {
    id: 2,
    ...
    bonus: [
      ...
      { name: "Spostrzegawczość: ", change: ""},
      { name: "Inteligencja: ", change: ""},
      { name: "Szybkość: ", change: ""},
      { name: "Obrona: ", change: "+15"},
      { name: "Przyrost złota: ", change: ""},
      { name: "Przyrost drewna: ", change: ""},
  ...
  return (
    ...
    <button onClick={getPrevSlide}>{"<"}</button>
      ...
      <div className="bonus">{slides[1].bonus.map((bonus) => {
        if (bonus.change !== "" ) {
        return <div key={bonus.id}>{bonus.name}{bonus.change}</div> }
        }
      )}
      </div>
