...
const description = [
  {
    name: "Skraj lasu",
    descript: `Przyjemnie wyglądająca, wręcz zachęcająca ścieżka prowadzi wokół lasu.
  ...
  {
    name: "Leśne odstępy",
    descript: `Kiedy już udaje ci się nie myśleć o wymierzonych w ciebie łukach zdziczałych band Elfów czy
  ...
  },
  {
    ...
    descript: `Ścieżka wiodąca wgłąb lasu już od samego początku wygląda ponuro. Właściwie nie jest to nawet ścieżka, co po prostu wydeptany przez zwierzynę wąski szlak.
